...
module.exports = simple = async (simple, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6281339888334@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		faketeks = '©GMS BOTZ' //Ganti Aja Nama Luh
		const isUrl = (url) => {
...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = simple.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝑴𝑬𝑵𝑼 GMS BOTZ☕","footerText": `Hallo Kak :v\n🔖Name Bot = GMS BOTZ\nKLIK MENU NYA KAK :)`,"listType": "SINGLE_SELECT","sections": list}}, {})
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `ciptaan : RiskiGanz📎`,  //Ganti Aja Nama Luh
                            orderTitle: `ciptaan :  Riski Ganz📎`,
        ...
        const fakeitem = (teks) => {
           simple.sendMessage(from, teks, text, {
                   quoted: {
                           ...
                           remoteJid :"6281339888334-1604595598@g.us" }: {})
                           },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync("./media/Menu.jpg"),"itemCount":300,"status":"INQUIRY","surface":"CATALOG","message": `ciptaan : Riski ganz 📎`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}},
...
I'M GMS BOT, SIAP MELAYANI ANDA`
trans = `BOT INFO
ッ _*Nama Bot : ${botname}*_
ッ  _️Nama Owner : ${ownername}_
️ッ _*Active : ${runtime(process.uptime())}*_
ッ  _️Prefix : Multi_
ッ  _lenguage : JavaScript_
ッ  _Jam : ${time}_
ッ _*Total User : User Aktif 1.868*_
...
_*Youtube*_
https://youtube.com/channel/UCc5cixXT3efHmoFsRxs7htA
_*Instagram*_
Gak main banh
_*Tiktok*_
tiktok.com/@grizlyganz3
_*Github*_
https://github.com/RiskiRj
...
but = [
          ...
          { buttonId: `${prefix}vn`, buttonText: { displayText: 'VN ⎙' }, type: 1 },
...
case 'ppcp': 
   ...
   sendButImage(from, pll, `GMS BOTZ © 2021`, cewe, [                      
          {
...
//━━━━━━━━━━━━━━━[ GAK TAU ]━━━━━━━━━━━━━━━━━//
              ...
              case 'command':
               list = []
            listmenu = [`Order`,`sewabot`,`groupmenu`,`stickermenu`,`downloadmenu`,`islammenu`,`animemenu`,`informationmenu`,`randomtextmenu`,`searchmenu`,`primbonmenu`,`stalkmenu`,`randomimagemenu`,`ownermenu`,`asupan`,`gabut`,`game`,`meme`,`murid`,`soundmenu`,`makermenu`,]
               listmenuu = [`Order`,`sewabot`,`grupmenu`,`stickermenu`,`downloadmenu`,`islammenu`,`animemenu`,`informationmenu`,`randomtextmenu`,`searchmenu`,`primbonmenu`,`stalkmenu`,`randomimagemenu`,`ownermenu`,`asupan`,`gabut`,`game`,`meme`,`murid`,`soundmenu`,`makermenu`,]
               nombor = 1
               startnum = 0
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe RiskiGanz`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `©_GMS BOTZ_ *V : 2.889H*`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
simple.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... sv nomor owner ku' })
fs.unlinkSync(ran)
})
break
...
button = [
 ...
 buttons = {
    contentText: 'Nih Owner Ku Mau Tanya? mau pesan bot? :)',
    footerText: faketeks,
    buttons: button,
    headerType: 1
}
...
for (let _ of anu) {
sendMess(_.jid, `[ *BOT GMS BROADCAST* ]\n\n${body.slice(4)}`)
}
reply('Suksess broadcast')
}
break
...
simple.sendMessage(`6281339888334@s.whatsapp.net`, options, text, { quoted: ftrol })
...
LINK GRUP BOT :
https://chat.whatsapp.com/F6Nm3qU8yXyHERhSHDI8gm

︶꒦꒷꒷꒦︶꒦꒷꒷꒦︶꒦꒷꒷꒦︶꒦꒷꒷꒦︶꒦꒷꒷꒦︶

ᥒႸ⍺rі рᥣр рᥱr⍺k⍺ᥒ ᥒ tut𝘰r 𝗆ur𝗆ᥱr?Ⴘukk 𝗆⍺𝗆ріr 𝖽і Riski 𝘚t𝘰rᥱ😋💘
...
*MAU BUY JASA? PILIH BUTTON Riski DI BAWAH*
─`
but = [
{ buttonId: `${prefix}dinda`, buttonText: { displayText: 'Riski' }, type: 1 }, 
...
*JOIN GRUB BOT KAWAN : https://chat.whatsapp.com/F6Nm3qU8yXyHERhSHDI8gm*

*ADMIN GMS MENYEDIAKAN :*
📢 GOBER
📢 OVOBER
📢 DANABER
📢 JASA CR 2k
...
📍RAGU? tenang kami siap kirim foto ktp + alamat
📍BE SMART BUYER Riski Ganz
─`
but = [
...
_*MAU JOIN? ATAU MAU SEWA? KLIK BUTTON Riski DI BAWAH*_
...
sendButton(from, "GOPAY : 081339888334", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'OWNER 🔥' }, type: 1 }
]
sendButton(from, "DANA : 081339888334", faketeks, but, mek)
break
case 'ovo':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'OWNER 🔥' }, type: 1 }
]
sendButton(from, "OVO : 081339888334", faketeks, but, mek)
break
...
const buMess = {
    ...
    footerText: '🔖 _1.868 >Author Aktif_',
    buttons: buttonss,
    headerType: 1
}
...
but = [
        ...
        sendButton(from, teks, '©Created : GMS Bot', but, mek)
break
